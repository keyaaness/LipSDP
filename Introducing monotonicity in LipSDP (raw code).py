...
# **Conclusion:** The variant of LipSDP gives a tighter bound than the trivial one and works better than the original LipSDP algorithm for about 50-70% of the cases
